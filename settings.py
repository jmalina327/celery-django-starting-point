...
SECRET_KEY = 'att+j@_6-juevi9luxi^x8z)sng)griq1w9+fi@ryxexzxxd8!'
...
# Where celerycam stores data. If this is not here, the data goes nowhere
...
CELERYD_TASK_TIME_LIMIT = 320
CELERYD_SOFT_TASK_TIME_LIMIT = 300
